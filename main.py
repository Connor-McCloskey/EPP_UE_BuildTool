...
There are a few paths in the Config Vars section you need to set for your machine
...
I'll be making some edits in the future to allow some of this to use command line args as well, but for now...
"""
...
project_path = "D:\\MyGameProjects\\MyGame"

# Path to the project config file containing the game version (DefaultGame.ini)
config_file_path = "D:\\MyGameProjects\\MyGame\\Config\\DefaultGame.ini"
...
# new version
# Will be fully generated by this script, so don't need to fill in
new_version = ""

# Base build directory on your machine
builds_dir = "D:\\MyGameProjects\\Builds\\MyGameBuilds\\"
...
# Found under your installation folder > Engine > Build > BatchFiles
uat_path = "C:\\Program Files\\Epic Games\\UE_5.4"
